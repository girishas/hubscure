...
! function(t, e) {
    ...
    return function(t) {
        ...
        function F(t, e, n) {
            return n.func ? n.func(t, e) : O(t[n.field], e[n.field]) * (n.order || 1)
        }
        ...
        Object.defineProperty(e, "__esModule", {
            value: !0
        }), e.version = "3.8.0", e.internalApiVersion = 12;
        var i = n(4);
            ...
            l = function(t) {
                ...
                return i.__extends(e, t), e.prototype.setElement = function(e) {
                    ...
                    this.el.on(e, function(t) {
                        if (!r(t.target).is(i.segSelector + "," + i.segSelector + " *,.fc-more,a[data-goto]")) return n.call(i, t)
                    })
                    ...
                    t.on(e, this.segSelector, function(t) {
                        var e = r(t.currentTarget).data("fc-seg");
            ...
            o = function() {
                ...
                return t.prototype.opt = function(t) {
                    ...
                    var n = t.footprint.componentFootprint,
                        ...
                        s = o.unzonedRange;
                    return i.startMs - s.startMs || s.endMs - s.startMs - (i.endMs - i.startMs) || o.isAllDay - n.isAllDay || r.compareByFieldSpecs(t.footprint.eventDef, e.footprint.eventDef, this.view.eventOrderSpecs)
                }, t
            }();
        e.default = o
    }, , , , , function(t, e, n) {
        ...
        var s = n(2),
            ...
            f = function(t) {
                ...
                return s.__extends(e, t), e.prototype.instantiateTimeGrid = function() {
                    return new(i(this.timeGridClass))(this)
        ...
        var i = n(3),
            ...
            o = n(4),
            s = n(216);
        n(10), n(47), n(252), n(253), n(255), n(256), n(257), n(258), i.fullCalendar = r, i.fn.fullCalendar = function(t) {
                    ...
                    return u && i.each(u.split(" "), function(t, s) {
                        ...
                        i.each(s.split(","), function(t, s) {
                            ...
                            "title" === s ? (h = h.add(i("<h2>&nbsp;</h2>")), f = !1) : ((l = d[s]) ? (g = function(t) {
                                ...
                                n[s]()
                            }, (y = c[s]) || (v = o.getIconClass(s)) || (y = p[s])), g && (w = ["fc-" + s + "-button", o.getClass("button"), o.getClass("stateDefault")], y ? m = r.htmlEscape(y) : v && (m = "<span class='" + v + "'></span>"), b = i('<button type="button" class="' + w.join(" ") + '">' + m + "</button>").click(function(t) {
